            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                >
                    ...
                    <h2 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
                        How It <span style={{ color: colours.primaryBlue }}>Works</span>
                    </h2>
                    <p className="text-base md:text-lg opacity-80" style={{ color: colours.gray600 }}>
                        A streamlined process that leverages cutting-edge AI to find your ideal match in the startup ecosystem and validate deep compatibility
                    </p>
                </motion.div>
