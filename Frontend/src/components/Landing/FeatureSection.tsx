...
export const FeatureSection: React.FC = () => {
    ...
    return (<section
        ...
        aria-label="KarmicDD Features and Benefits">
        ...
        <div className="container mx-auto px-4">
            ...
            >
                ...
                >
                    Why Choose KarmicDD for Due Diligence
                </motion.h2>
                <motion.p
                ...
                >
                    ...
                    <span className="font-semibold" style={{ color: colours.indigo600 }}> shared values, financial transparency, and data-driven insights</span> for the Indian startup ecosystem.
                </motion.p>
            </motion.div>
