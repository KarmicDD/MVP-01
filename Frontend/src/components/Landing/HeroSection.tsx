...
export const HeroSection: React.FC = () => {
    ...
    return (<section
        ...
        aria-label="KarmicDD Hero Section"
    >
        ...
        <div className="container mx-auto px-4 relative z-10">
            ...
            >
                ...
                >                    <h1 className="text-3xl md:text-5xl font-bold mb-4 md:mb-6 leading-tight">
                        <span style={{ color: colours.indigo600 }}>KarmicDD</span> - AI-Powered Due Diligence Platform for <span style={{ color: colours.indigo600 }}>Startups & Investors</span>
                    </h1>
                    <p className="text-base md:text-lg mb-6 md:mb-8 max-w-xl" style={{ color: colours.gray600 }}>
                        Transform your investment process with KarmicDD's intelligent matching, comprehensive financial analysis, and belief-based compatibility scoring. Built for the Indian startup ecosystem.
                    </p>
                    <motion.div
