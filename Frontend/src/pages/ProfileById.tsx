    ...
    useEffect(() => {
        const fetchProfileById = async () => {
            ...
            try {
                ...
                try {
                    const profileResponse = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:5000/api'}/profile/public/${userId}`);
                ...
                try {
                    ...
                    const startupResponse = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:5000/api'}/search/startups?userId=${userId}`);
                ...
                try {
                    ...
                    const investorResponse = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:5000/api'}/search/investors?userId=${userId}`);
